            ...
            if (series.numberOfFrames !== undefined) {
                ...
                for (var i = 0; i < numberOfFrames; i++) {
                    ...
                    if (imageId.substr(0, 4) !== 'http') {
                        ...
                        //imageId = "dicomweb://breastscreening.isr.tecnico.ulisboa.pt:4550/instances/" + imageId;
                        imageId = "wadouri://breastscreening.isr.tecnico.ulisboa.pt:4550/instances/" + imageId;
                        //imageId = "wadouri://breastscreening.isr.tecnico.ulisboa.pt:4550/wado?objectUID=" + imageId + "&requestType=WADO&contentType=application/dicom";
                ...
                series.instanceList.forEach(function(image) {
                    ...
                    if (image.imageId.substr(0, 4) !== 'http') {
                        ...
                        //imageId = "dicomweb://breastscreening.isr.tecnico.ulisboa.pt:4550/instances/" + image.imageId;
                        imageId = "wadouri://breastscreening.isr.tecnico.ulisboa.pt:4550/instances/" + image.imageId;
                        //imageId = "wadouri://breastscreening.isr.tecnico.ulisboa.pt:4550/wado?objectUID=" + image.imageId + "&requestType=WADO&contentType=application/dicom";
